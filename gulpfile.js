...
export const css = () => {
    ...
    .pipe(sass({
        outputStyle: "compressed" //expanded, compact //експандед стандартний вигляд css, компрес все в одну стрічку
    })
...
export const js = () => {
    ...
    .pipe(uglify.default()) // мініфікує js в одну змінну, переіменовує змінних
